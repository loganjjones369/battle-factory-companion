...
function QuickReference({ source, target, side, setId, setProbabilities = {}, onSet, onConfirmSet, onObserveMove, onObserveItem, onObserveAbility, onClearClue, observedAbility, observedMoves = [], observedItem = '', scenario, onScenarioChange, onRecordObservedDamage, onClearObservedDamage }) {
