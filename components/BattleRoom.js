...
function QuickReference({ source, target, side, setId, setProbabilities = {}, onSet, onObserveMove, onObserveItem, onObserveAbility, observedAbility, scenario, onScenarioChange }) {
