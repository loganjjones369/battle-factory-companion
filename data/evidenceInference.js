import {getStats,getEffectiveSpeed,applyStatStages,calculateDamage} from './damageCalc.js';
import {getFactorySet} from './setIdentity.js'; const norm=v=>String(v||'').trim().toLowerCase();
